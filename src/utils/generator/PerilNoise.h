...
#ifndef GAMEENGINE_PERILNOISE_H
#define GAMEENGINE_PERILNOISE_H
...
inline void testPerlinNoise1(void){
...
inline void testPerlinNoise2(void){
    // Define the size of the image
    unsigned int width = 600, height = 450;
