...
public:
    ...
    static Matrix4f * rotate(float angle, Vector3f axis, Matrix4f * src, Matrix4f * dest = nullptr) {
        if (!dest)
            dest = new Matrix4f();
    ...
    static Matrix4f * initScale(float x, float y, float z){
    ...
    static Matrix4f * initTranslation(float x, float y, float z){
        Matrix4f * result = new Matrix4f();
    ...
    static Matrix4f * initRotation(float x, float y, float z){
    ...
    static Matrix4f * initPerspective(float fov, float aspectRatio, float zNear, float zFar){
