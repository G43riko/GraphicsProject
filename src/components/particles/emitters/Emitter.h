...
protected:
    ...
    virtual void emitParticle(Vector3f center){
...
public:
    inline Emitter(PointerParticleTexture texture, ParticleManager& parent, float pps, float speed, float gravityComplient, float lifeLength) :
            pps(pps),
            speed(speed),
    ...
    virtual void update(float delta, Vector3f systemCenter) {
