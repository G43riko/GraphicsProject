...
#ifndef GRAPHICSPROJECT_PARTICLESYSTEMCOMPLEX_H
#define GRAPHICSPROJECT_PARTICLESYSTEMCOMPLEX_H


class ParticleSystemComplex {
/*
...
#endif //GRAPHICSPROJECT_PARTICLESYSTEMCOMPLEX_H
